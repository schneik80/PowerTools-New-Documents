...
CMD_ID = "PTND-setLocation"
CMD_Description = "Show document in file location"
...
def command_execute(args: adsk.core.CommandCreatedEventArgs):
    ...
    try:
        ...
        ShowInLocationCmd = cmdDefs.itemById("ShowInLocationCommand")
        ShowInLocationCmd.execute()
